    ...
    >
      ...
      >
        <div className="grid sm:grid-cols-2">
          <div className="relative aspect-[3/4] bg-paper sm:aspect-auto">
          ...
          <div className="flex flex-col p-6 sm:p-8">
            ...
            {product.color && (
              <p className="mt-1.5 text-sm text-muted">Cor: {product.color}</p>
            )}
            ...
            <div className="mt-6 border-t border-line pt-5">
              ...
              <p className="mt-1.5 text-sm leading-relaxed text-muted">
                Consulte medidas, disponibilidade em estoque e preço pelo
                WhatsApp.
              </p>
            </div>
            ...
            <div className="mt-auto pt-8">
              <a
                ...
                className="flex w-full items-center justify-center gap-2 rounded-full bg-whatsapp py-3.5 text-sm font-semibold uppercase tracking-wider text-white shadow-sm transition hover:brightness-95"
              >
